...
```javascript
iterEmpty = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-empty@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/iter-empty@v0.1.1-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/iter-empty/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/iter-empty/actions/workflows/test.yml?query=branch:v0.1.1
